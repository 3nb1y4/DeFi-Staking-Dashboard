...
program
  ...
  .option('-t, --template <type>', 'Template type (basic, farcaster-miniapp, minipay, ai-chat, staking)') // Güncellendi
...
// Ekstra komut eklemek istersen buraya gelir (örn: program.command('staking')...)
